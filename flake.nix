{
  description = "gp-saml-gui: Interactively authenticate to GlobalProtect VPNs that require SAML";
  ...
  outputs = { self, nixpkgs, flake-utils, gp-saml-gui, ... }@inputs:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
          ...
          apps.gp-saml-gui = flake-utils.lib.mkApp { drv = packages.gp-saml-gui; };
